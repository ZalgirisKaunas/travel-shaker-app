  ...
  <q-layout view="lHh Lpr lFf" class="layout_tourastio">
    ...
    <q-header class="bg-transparent">
      <q-toolbar :class="{ blur: counterr === 9 }" class="text-center">
        ...
        <q-toolbar-title class="text-positive">
          Tourastico
        </q-toolbar-title>
      ...
      <q-linear-progress v-if="counterr !== 9" :value="progressVal" track-color="warning" color="black" />
...
export default defineComponent({
  ...
  setup () {
    ...
    const progressVal = computed(() => Number((0.1 * (counterr.value-1)).toFixed(1)));
