<template>
  <q-list>
    <q-item tag="label" v-ripple class="radio-group-big">
      <q-item-section>
        <q-item-label><img class="selection-img"
    ...
    <q-item tag="label" v-ripple class="radio-group-big">
      ...
      <q-item-section avatar>
        <q-radio v-model="gender" unchecked-icon="fa-solid fa-check" checked-icon="fa-solid fa-check" val="female" gender="female"/>
      </q-item-section>
    ...
    <q-item tag="label" v-ripple class="radio-group-big">
      ...
      <q-item-section avatar>
        <q-radio v-model="gender" unchecked-icon="fa-solid fa-check" checked-icon="fa-solid fa-check" val="other" gender="other"/>
      </q-item-section>
