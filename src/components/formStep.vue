...
<div>
  <div class="form-header">
    <div v-if="step === 1" class="flex happy-users"><img src="~assets/stars.png"><p class="text-body">10 000+ happy users</p>
...
<!--    <button v-if="step > 1" @click="prevStep">Previous</button>-->
    <q-btn unelevated flat class="btn-main" v-if="step > 1  && next"
           label="Next"
           @click="nextStep" />
  </div>
</template>
